                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-2 text-center">
                                        <img class="img-responsive" id="image" src="image/user.jpg" alt="prewiew" width="180" height="170">
                                    </div>
                                        ...
                                        <div class="col-16 text-sm-center col-sm-16 text-md-left col-md-16">
                                            <table style="width:100%">
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="userID" value="${param.userID}" size="40" required></td>
                                                    <td><i><font color="red">${requestScope.errorUser.userID}</font></i></td>
                                                </tr>
                                                <tr>
                                                    <td><font color="Blue">Name: </font></td>
                                                    <td><input type="text" name="userName" value="${param.userName}" size="40" required></td>
                                                    <td><i><font color="red">${requestScope.errorUser.userName}</font></i></td>
                                                </tr>
                                                <tr>
                                                    <td><font color="Blue">Password: </font></td>
                                                    <td><input type="password" name="password" value="${param.password}" size="40" required></td>
                                                    <td><i><font color="red">${requestScope.errorUser.password}</font></i></td>
                                                </tr>
                                                <tr>
                                                    <td><font color="Blue">Password confirm: </font></td>
                                                    <td><input type="password" name="passwordConfirm" value="${param.password}" size="40" required></td>
                                                    <td><i><font color="red">${requestScope.errorUser.passwordConfirm}</font></i></td>
                                                </tr>
                                                <tr>
                                                    <td><font color="Blue">Email: </font></td>
                                                    <td><input type="text" name="email" value="${param.email}" size="40" required></td>
                                                    <td><i><font color="red">${requestScope.errorUser.email}</font></i></td>
                                                </tr>
                                                <tr>
                                                    <td><font color="Blue">Phone: </font></td>
                                                    <td><input type="text" name="phone" value="${param.phone}" size="40" required></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="file" name="photo"onchange="readURL(this);" accept="image/gif, image/jpeg, image/png" required/></td>
                                                </tr>    
                                            </table>
